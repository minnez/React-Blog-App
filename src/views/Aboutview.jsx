...
const Aboutview = () => {
    ...
    return ( 
        <div className="aboutview-main" style={{backgroundColor: theme.drop, color: theme.syntax}}>
            ...
            {aboutprofile && (
                <div className="about-profile">
                    ...
                    <div className="about-follows">
                        <div className="f-n">{aboutprofile.following.length}<div className="f-l">&nbsp;Following</div></div>
                        <div className="f-n">{aboutprofile.followers.length}<div className="f-l">&nbsp;Followers</div></div>
                    </div>
                </div>
            )}
